...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token="Eov1SpnG44JIsZ4NVPg3.nBT543FxoLpZYt29i8ceSW.Iv95AOM9S26wrzPIJbMIu3eRL22kx/ZEpJS546zd/Gg=")#1
kr.loginResult()

kr1 = KRIS.LINE()
#kr1.login(qr=True)
kr1.login(token="EojS4ETx2sOH00WfFjC5.4rKGviaiWRJ5DCBItMOEXq.mTYypZHV1YK4zETTOBfA9JyWW7zKHaO+mvxb3Kcgdr0=")#2
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EoLPu0kDftICcM80Gmhd.P2aClM+I9p69+RZN6xQ4Vq.kOyPsJm7/dRxJrvSVMja1RAwPuGa0YOVuBjUYixjjLY=")#r3
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EouXNKxX6QsUznbGIW67.a4rbvxl6R/7QoeX2DrGgrW.2dihUHyqVpgXxOQ/iFXO4E3nzHqmx3XZQXWvqNvg4N8=")#r4
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="EoDp4XHbdX0r91qr8uzb.+i/EYC+vgrcMG1HqZG+0/W.H9sDu2/tvQWV7ECkDyIy4xdnOrm1+e0ScQRYTJHIufA=")#r5
kr4.loginResult()

kr5 = KRIS.LINE()
#kr5.login(qr=True)
kr5.login(token="EoCpXFmrZhynmDAoLiP7.J+E+ZpnsMtHxl4GccBIhPW.T6XhbcDbYDmQiuDK78eIlSOOEwLposkrOtLEZ//dDKA=")#r6
kr5.loginResult()
...
admin=["ubd47e33f0bfa9782cbde32e03e3e0707",mid,mid1,mid2,mid3,mid4,mid5]
